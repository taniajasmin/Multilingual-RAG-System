...
def preprocess_text(text: str, language: str = "bn") -> str:
    ...
    if language == "bn":
        text = re.sub(r"[^\u0980-\u09FF\s।,.\-অ-ঔ0-9]", "", text)  # Keep numbers and basic punctuation
    else:
...
def load_pdf_corpus(file_path: str) -> str:
    ...
    else:  # Handle PDF case if needed
...
def create_vector_store(text: str) -> FAISS:
    ...
    print(f"Number of chunks: {len(chunks)}")  # Debug
    print(f"First chunk: {chunks[0]}")  # Debug
